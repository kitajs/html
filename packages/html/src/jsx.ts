...
declare global {
  namespace JSX {
     ...
     *
     * Direct calls of `Html.createElement` uses correct return type based on its
     * children. However, when using JSX syntax, typescript does not support this yet.
     *
    ...
    interface HtmlTag extends ElementChildrenAttribute, IntrinsicAttributes {
      ...
      /**
       * When set to true, all inner content (html or not) of this tag will be escaped
       * when evaluated.
       *
      ...
      /**
       * The html class property. You can use an array to represent conditional class
       * names. Similar to the `clsx` package behavior.
       *
       * @example
       *
       * ```tsx
    ...
    interface IntrinsicAttributes {
       ...
       * Consequently, the `'key'` attribute is not included in the properties parameter
       * of any component or element.
       *
       * **If you intend to utilize a similar property, please opt for an alternate
       * name.**
       *
    ...
    interface ElementChildrenAttribute {
      children?: undefined | import('./index.js').Children;
    }
