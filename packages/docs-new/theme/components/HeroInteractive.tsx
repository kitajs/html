          ...
          <div className={styles.editorArea}>
            ...
            <div className={styles.codeEditor}>
              ...
              <div className={styles.codeContent}>
                <div><span className={styles.variable}>fs</span><span className={styles.punctuation}>.</span><span className={styles.function}>writeFileSync</span><span className={styles.punctuation}>(</span></div>
                <div>{'  '}<span className={styles.string}>'index.html'</span><span className={styles.punctuation}>,</span></div>
                <div>{'  '}<span className={styles.jsx}>&lt;p&gt;</span></div>
                <div>{'    '}Hello, <span className={styles.jsx}>&lt;b&gt;</span>world<span className={styles.jsx}>&lt;/b&gt;</span>!</div>
                <div>{'  '}<span className={styles.jsx}>&lt;/p&gt;</span></div>
                <div><span className={styles.punctuation}>);</span></div>
              </div>
            </div>
          </div>
        </div>
