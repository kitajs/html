...
The `@kitajs/ts-html-plugin` is both a **TypeScript Language Service Plugin** and a **CLI tool** for detecting XSS vulnerabilities.
...
The plugin hooks into TypeScript's language service to analyze JSX expressions in real-time:
