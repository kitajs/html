...
The JSX runtime is the core transformation layer that converts JSX syntax into HTML strings.
...
:::tip Recommendation
Use the modern JSX transform (`react-jsx`) for better performance and smaller bundle sizes.
:::
