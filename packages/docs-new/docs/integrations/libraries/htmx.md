...
- Try [Alpine.js integration](/integrations/libraries/alpine)
- Learn about [Hotwire Turbo](/integrations/libraries/turbo)
- Explore [Base HTML Templates](/integrations/libraries/base-templates)
