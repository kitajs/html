  ...
  return (
    <div>
      ...
      <div id="root">
        ...
        <div className="page-wrapper  category-home standard-page ">
          <div className="top-banner loading">
            <section className="place top container" />
          </div>
          <header className="top-navigation main-document-header-container dark">
            <div className="container ">
              <div className="top-navigation-wrap">
                <a href="/pt-BR/" className="logo" aria-label="MDN homepage">
                  <svg
                    id="mdn-docs-logo"
                  ...
                  >
                    ...
                    <path
                      ...
                      className="logo-m"
                    />
                    <path d="M294 95h67v8.8h-67z" className="logo-_" />
                  </svg>
                </a>
                <button
              ...
              <div className="top-navigation-main">
                <nav className="main-nav" aria-label="Main menu">
                  <ul className="main-menu nojs">
                    <li className="top-level-entry-container">
                      ...
                      <a href="/pt-BR/docs/Web" className="top-level-entry">
                        References
                      </a>
                      <ul
                        id="references-menu"
                        className="submenu references hidden inline-submenu-lg"
                        aria-labelledby="references-button"
                      >
                        <li className="apis-link-container mobile-only ">
                          <a href="/pt-BR/docs/Web" className="submenu-item ">
                        ...
                        <li className="html-link-container ">
                          <a href="/pt-BR/docs/Web/HTML" className="submenu-item ">
                            <div className="submenu-icon html" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">HTML</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="css-link-container ">
                          <a href="/pt-BR/docs/Web/CSS" className="submenu-item ">
                            <div className="submenu-icon css" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">CSS</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="javascript-link-container ">
                          <a href="/pt-BR/docs/Web/JavaScript" className="submenu-item ">
                            <div className="submenu-icon javascript" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">JavaScript</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="http-link-container ">
                          <a href="/pt-BR/docs/Web/HTTP" className="submenu-item ">
                            <div className="submenu-icon http" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">HTTP</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="apis-link-container ">
                          <a href="/pt-BR/docs/Web/API" className="submenu-item ">
                            <div className="submenu-icon apis" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Web APIs</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="apis-link-container ">
                          ...
                          >
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Web Extensions</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="apis-link-container desktop-only ">
                          <a href="/pt-BR/docs/Web" className="submenu-item ">
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Web Technology</div>
                              <p className="submenu-item-description">
                                Web technology reference for developers
                              </p>
                            </div>
                    ...
                    <li className="top-level-entry-container">
                      ...
                      <a href="/pt-BR/docs/Learn" className="top-level-entry">
                        Guides
                      </a>
                      <ul
                        id="guides-menu"
                        className="submenu guides hidden inline-submenu-lg"
                        aria-labelledby="guides-button"
                      >
                        <li className="apis-link-container mobile-only ">
                          <a href="/pt-BR/docs/Learn" className="submenu-item ">
                            <div className="submenu-icon learn" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">
                        ...
                        <li className="html-link-container ">
                          <a href="/pt-BR/docs/Learn/HTML" className="submenu-item ">
                            <div className="submenu-icon html" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">HTML</div>
                              <p className="submenu-item-description">
                        ...
                        <li className="css-link-container ">
                          <a href="/pt-BR/docs/Learn/CSS" className="submenu-item ">
                            <div className="submenu-icon css" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">CSS</div>
                              <p className="submenu-item-description">
                        ...
                        <li className=" ">
                          ...
                          >
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Accessibility</div>
                              <p className="submenu-item-description">
                    ...
                    <li className="top-level-entry-container">
                      ...
                      <a href="/pt-BR/plus" className="top-level-entry">
                        Plus
                      </a>
                      <ul
                        id="mdn-plus-menu"
                        className="submenu mdn-plus hidden inline-submenu-lg"
                        aria-labelledby="mdn-plus-button"
                      >
                        <li className=" ">
                          <a href="/pt-BR/plus" className="submenu-item ">
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Overview</div>
                              <p className="submenu-item-description">
                        ...
                        <li className=" ">
                          <a href="/pt-BR/plus/ai-help" className="submenu-item ">
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">AI Help (beta)</div>
                              <p className="submenu-item-description">
                        ...
                        <li className=" ">
                          <a href="/pt-BR/plus/updates" className="submenu-item ">
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Updates</div>
                              <p className="submenu-item-description">
                        ...
                        <li className=" ">
                          ...
                          >
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">Documentation</div>
                              <p className="submenu-item-description">
                        ...
                        <li className=" ">
                          <a href="/en-US/plus/docs/faq" className="submenu-item ">
                            <div className="submenu-icon" />
                            <div className="submenu-content-container">
                              <div className="submenu-item-heading">FAQ</div>
                              <p className="submenu-item-description">
                    ...
                    <li className="top-level-entry-container">
                      <a className="top-level-entry menu-link" href="/pt-BR/play">
                        Play
                      </a>
                    </li>
                    <li className="top-level-entry-container">
                ...
                <div className="header-search">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="button action has-icon search-button"
                    >
                      <span className="button-wrap">
                ...
                <div className="theme-switcher-menu">
                  ...
                  >
                    <span className="button-wrap">
                      <span className="icon icon-theme-os-default " />
                      Theme
                    </span>
                  </button>
                </div>
                <ul className="auth-container">
                  ...
                  <li>
                    ...
                    >
                      <span className="button-wrap">Sign up for free</span>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="homepage mdn-ui-body-m">
              <div className="homepage-hero dark">
                ...
                <div className="mandala-container  homepage-hero-bg" aria-hidden="true">
                  <div className="mandala-translate mandala-rotate">
              ...
              <section className="place hp-main" />
              <div className="featured-articles">
                ...
                <div className="tile-container">
                  ...
                  <div className="article-tile">
                    <a href="/en-US/docs/Web/API" className="tile-tag">
                      Web APIs
                    </a>
                    <h3 className="tile-title">
              ...
              <section className="latest-news">
                ...
                <ul className="news-list">
                  <li className="news-item">
                    ...
                    <span className="news-date">2 months ago</span>
                  </li>
                  <li className="news-item">
                    <p className="news-title">
                      <span>
                      ...
                      <span>
                        <a className="news-source" href="/en-US/blog/">
                          developer.mozilla.org
                        </a>
                      </span>
                    </p>
                    <span className="news-date">3 months ago</span>
                  </li>
                  <li className="news-item">
                    <p className="news-title">
                      <span>
                ...
                <ul className="contribution-list">
                  <li className="request-item">
                    <p className="request-title">
                      ...
                      <span>
                        <a className="request-repo" href="https://github.com/mdn/content">
                          mdn/content
                        </a>
                      </span>
                    </p>
                    <span className="request-date">8 hours ago</span>
                  </li>
                  <li className="request-item">
                    <p className="request-title">
                  ...
                  <li className="request-item">
                    ...
                    <span className="request-date">9 hours ago</span>
                  </li>
                  <li className="request-item">
                    <p className="request-title">
                  ...
                  <li className="request-item">
                    ...
                    <span className="request-date">10 hours ago</span>
                  </li>
                  <li className="request-item">
                    <p className="request-title">
                  ...
                  <li className="request-item">
                    ...
                    <span className="request-date">14 hours ago</span>
                  </li>
                  <li className="request-item">
                    <p className="request-title">
                    ...
                    <span className="request-date">18 hours ago</span>
                  </li>
                  <li className="request-item">
                    <p className="request-title">
                    ...
                    <span className="request-date">a day ago</span>
                  </li>
                </ul>
              </section>
          ...
          <div className="page-footer-grid">
            ...
            <div className="page-footer-nav-col-2">
              ...
              <ul className="footer-nav-list">
                ...
                <li className="footer-nav-item">
                  <a className="footer-nav-link" href="/pt-BR/docs/MDN/Community/Issues">
                    Report an issue
                  </a>
                </li>
              </ul>
            ...
            <div className="page-footer-nav-col-4">
              ...
              <ul className="footer-nav-list">
                <li className="footer-nav-item">
                  <a className="footer-nav-link" href="/pt-BR/docs/Web">
                    Web Technologies
                  </a>
                </li>
                <li className="footer-nav-item">
                  <a className="footer-nav-link" href="/pt-BR/docs/Learn">
                    Learn Web Development
                  </a>
                </li>
                <li className="footer-nav-item">
                  <a className="footer-nav-link" href="/pt-BR/plus">
                    MDN Plus
                  </a>
                </li>
                <li className="footer-nav-item">
